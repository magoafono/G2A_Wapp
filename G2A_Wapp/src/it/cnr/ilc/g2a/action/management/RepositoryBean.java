package it.cnr.ilc.g2a.action.management;

import it.cnr.ilc.g2a.action.userbean.AnalysisBean;
import it.cnr.ilc.g2a.action.userbean.SearchBean;
...
import it.cnr.ilc.g2a.model.handler.EntityManager;
...
public class RepositoryBean {
    ...
    public String getArabicPericopeDomAsString() {
        return "";
        /*em.pericopeDomAsString(Consts.ARABIC)*/
    }
        ...
        switch (langId) {
            case Consts.GREEK:
                ...
                try {
                    ...
                    logger.error("Error retrieving greek pericope by id=(" + pericopeId + ")");
                }
                break;
    ...
    private HashMap<String, ResultViewEntity> simpleSearchLinksByTokens(SearchBean parameters, int lang) {
        ...
        if (logger.isDebugEnabled()) {
            profiler = new Profiler("RepositoryBean.simpleSearchLinksByTokens()");
        }
        for (int i = 0; i < 3; i++) {
