...
public class G2ASort {
    ...
    private static final Logger log = LogManager.getLogger("G2ASort");

    public static final Comparator<Comment> COMMENT_ID_ORDER
    ...
    public static final Comparator<TokenViewEntity> TOKENVIEW_FROM_ORDER
    ...
    public static final Comparator<LinkViewEntity> GREEKLINKVIEW_FROM_ORDER2
    ...
    /**
     * Ordinamento per le pericopi arabe. E' stato modificato dall'ordinamento
     * usando i ref come float perche' non funziona nel caso in cui una pericope
     * sia a cavallo di 2 pagine. es. 29.1403 verrebbe prima di 29.1414 perche'
     * confrontandoli come float il secondo e' piu' grande e quindi ipotizzato
     * successivo, al primo che invece e' a cavallo della pagina 29 e 30 e
     * quindi successivo al secondo Per ovviare al problema si scompone il ref
     * in pagina, riga di inizio e riga di fine.
     */
    public static final Comparator<LinkViewEntity> ARABICLINKVIEW_FROM_ORDER2
            = new Comparator<LinkViewEntity>() {
    ...
    public static final Comparator<LinkViewEntity> ARABICLINKVIEW_FROM_ORDER3
            = new Comparator<LinkViewEntity>() {
    ...
    private static int compareId(String v1, String v2) {
        ...
        if (v1 == null || v2 == null) {
            log.error("ERR: CophiSort.compareId (" + v1 + ", " + v2 + ")");
            return 0;
        }
        String[] components1 = v1.split("\\.");
        String[] components2 = v2.split("\\.");
        ...
        log.error("Come mai qui??? " + v1 + " " + v2 + " " + components1.length + " " + components2.length);
        return components1.length - components2.length;
    }

    public static final Comparator<LinkViewEntity> GREEKLINKVIEW_FROM_ORDER
            = new Comparator<LinkViewEntity>() {
    ...
    public static final Comparator<LinkViewEntity> ARABICLINKVIEW_FROM_ORDER
            = new Comparator<LinkViewEntity>() {
    ...
    public static final Comparator<TokenText> TOKENTEXT_FROM_ORDER
    ...
    public static final Comparator<Reference> TOKENREF_FROM_ORDER
    ...
    public static final Comparator<Reference> TOKENREF_FROM_ORDER_OLD
            = new Comparator<Reference>() {
