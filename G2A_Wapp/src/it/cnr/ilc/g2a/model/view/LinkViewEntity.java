...
public class LinkViewEntity {
	...
	private String greekPericopeId = null;
	private String arabicPericopeId = null;
	private boolean isGreekPericopeHidden = false;
	private boolean isArabicPericopeHidden = false;
	...
	/**
	 * @return the greekPericopeId
	 */
	public String getGreekPericopeId() {
		return greekPericopeId;
	}

	/**
	 * @param greekPericopeId the greekPericopeId to set
	 */
	public void setGreekPericopeId(String greekPericopeId) {
		this.greekPericopeId = greekPericopeId;
	}

	/**
	 * @return the arabicPericopeId
	 */
	public String getArabicPericopeId() {
		return arabicPericopeId;
	}

	/**
	 * @param arabicPericopeId the arabicPericopeId to set
	 */
	public void setArabicPericopeId(String arabicPericopeId) {
		this.arabicPericopeId = arabicPericopeId;
	}

	/**
	 * @return the isArabicPericopeHidden
	 */
	public boolean isArabicPericopeHidden() {
		return isArabicPericopeHidden;
	}

	/**
	 * @param isArabicPericopeHidden the isArabicPericopeHidden to set
	 */
	public void setArabicPericopeHidden(boolean isArabicPericopeHidden) {
		this.isArabicPericopeHidden = isArabicPericopeHidden;
	}

	/**
	 * @return the isGreekPericopeHidden
	 */
	public boolean isGreekPericopeHidden() {
		return isGreekPericopeHidden;
	}

	/**
	 * @param isGreekPericopeHidden the isGreekPericopeHidden to set
	 */
	public void setGreekPericopeHidden(boolean isGreekPericopeHidden) {
		this.isGreekPericopeHidden = isGreekPericopeHidden;
	}
