...
import it.cnr.ilc.g2a.action.controller.content.CommentContentBehaviour;
import it.cnr.ilc.g2a.action.controller.content.ContextContent;
import it.cnr.ilc.g2a.action.controller.content.DocumentTextContentBehaviour;
import it.cnr.ilc.g2a.action.controller.content.LinkContentBehaviour;
import it.cnr.ilc.g2a.action.controller.content.PericopeTextContentBehaviour;
import it.cnr.ilc.g2a.action.controller.resource.ContextResource;
import it.cnr.ilc.g2a.action.controller.resource.ResourceBehaviour;
import it.cnr.ilc.g2a.action.controller.resource.XMLResourceBehaviour;
import it.cnr.ilc.g2a.action.userbean.AnalysisBean;
import it.cnr.ilc.g2a.exception.BugException;
...
import it.cnr.ilc.g2a.utils.XPathUtils;
import it.cnr.ilc.g2a.utils.GreekCollator.CollatorEnum;
...
public class EntityManager {
    ...
    /**
     * Nuova save che usa direttamente exist-db con xquery invece di ricostruire
     * tutto l'XML e salvarlo (metodo lentissimo!)
     *
     * @param focusedPericopeId id della pericope oggetto della modifica
     * (focused)
     * @param listOfPericopesId ids delle pericopi coivolte nella pericope
     * (solitamente dalle quali ho tolto tokens)
     */
    ...
    /**
     * It aligns the internal structures and the XML DB to the change made by a
     * user to pericopes
     *
    ...
    /**
     * Remove from the pericope idenfied by pericopesId the tokens listed in
     * tokensId list
     *
    ...
    /**
     * It adds tokens listed in tokensId list into the pericope with Id
     * focusedPericopeId
     *
     * @param tokensId list of token ids
     * @param focusedPericopeId ID of the focused pericope (in the pericope
     * manager)
     * @param langId
     */
    ...
    /**
     * Ricerca semplice. Restituisce l'insieme delle coppie di pericopi che
     * soddisfano i criteri di ricerca.
     *
     * @param word Termine da cercare. La tipologia (forma/lemma/radice) è
     * stabilita con <i>type</i>
     * @param type Tipologia (forma/lemma/radice) di interpretazione della
     * <i>word</>
    ...
    public HashMap<String, ResultViewEntity> simpleSearchLinksByTokens(List<String> itemName, List<String> itemValue, int lang) throws BugException {
        ...
        try {
            ...
            if (log.isDebugEnabled()) {
                profiler = new Profiler("simpleSearchLinksByTokens");
            }
