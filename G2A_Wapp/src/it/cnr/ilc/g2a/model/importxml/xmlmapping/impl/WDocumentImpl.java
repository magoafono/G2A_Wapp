 ...
 */
public class WDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.cnr.ilc.g2a.model.importxml.xmlmapping.WDocument
{
     ...
     * Gets the "w" element
     */
    public it.cnr.ilc.g2a.model.importxml.xmlmapping.WDocument.W getW()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.cnr.ilc.g2a.model.importxml.xmlmapping.WDocument.W target = null;
            target = (it.cnr.ilc.g2a.model.importxml.xmlmapping.WDocument.W)get_store().find_element_user(W$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "w" element
     */
    public void setW(it.cnr.ilc.g2a.model.importxml.xmlmapping.WDocument.W w)
    {
     ...
     * This is a complex type.
     */
    public static class WImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.cnr.ilc.g2a.model.importxml.xmlmapping.WDocument.W
    {
        private static final long serialVersionUID = 1L;
