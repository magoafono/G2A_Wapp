...
//	private final static String columnTemplate_4 = "termine classe inferita";
	...
	public String getQuery_1_param_2() {
		return repositoryBean.getQuery_1_param_2();
	}
	...
	public void setQuery_1_param_2(String query_1_param_2) {
		repositoryBean.setQuery_1_param_2(query_1_param_2);
	}
	...
	public void q_1_p_1Changed(AjaxBehaviorEvent event) {
		...
		queryString = Consts.NAMESPACES
				...
				+ getQuery_1_param_1() + " . } " + "ORDER BY ?termine";
	...
	public void runQuestion_1() throws IOException {
		...
		clearRes.clear();
//		columns.clear();
		if (getQuery_1_param_1().equals("ObjectProperty")) {
			...
			/*  String queryString = Consts.NAMESPACES
	                    + "SELECT DISTINCT ?property ?termine "
	                    + "WHERE { plotino:Being"
	                    + " ?property ?termine . ?property rdf:type owl:ObjectProperty"
	                    + " . } ORDER BY ?termine ?property ";*/
...
//		columns.clear();
		...
		String queryString = Consts.NAMESPACES
				+ "SELECT DISTINCT ?property "
				+ "WHERE { ?instA plotino:greekTerm '"
				+ getQuery_2_param_1()
				+ "' . ?instB plotino:greekTerm '" + getQuery_2_param_2()
				+ "' . ?instA ?property ?instB . } ORDER BY ?property ";
		...
		queryString = Consts.NAMESPACES
				...
				+ "WHERE { ?instA plotino:greekTerm '"
				+ getQuery_2_param_2()
				+ "' . ?instB plotino:greekTerm '" + getQuery_2_param_1()
				+ "' . ?instA ?property ?instB . } ORDER BY ?property ";
		...
		queryString = Consts.NAMESPACES
				...
				+ "WHERE { ?instA plotino:greekTerm '"
				+ getQuery_2_param_1()
				+ "' . ?instB plotino:greekTerm '" + getQuery_2_param_3()
				+ "' . ?instA ?property ?instB . } ORDER BY ?property ";
